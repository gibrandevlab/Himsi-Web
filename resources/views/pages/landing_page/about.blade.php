...
<div style="margin: 5rem 0px">
   <div class="container">
    ...
    <div class="card">
    <a href="{{ route('division.show', ['division' => $division]) }}" style="height: 100%;">
          <img class="img-fluid rounded" src="{{ asset("assets/img/" . $division . ".png") }}" style="height: 100%; object-fit: cover; width: 100%;" alt="">
        </a>
    </div>
</div>
