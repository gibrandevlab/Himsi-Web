...
Route::get('about/division/{division}', [DivisionController::class, 'show'])->name('division.show');

// Memproses hasil pemindaian QR code
...
// Mendefinisikan rute resource untuk ProkerController
Route::resource('proker', ProkerController::class);

// Mengaplikasikan middleware untuk memastikan pengguna sudah login
Route::middleware(array("loggedIn"))->group(function () {
    ...
    // Mengaplikasikan middleware untuk peran `isSecretary` dan `isLeader`
    Route::middleware(['isSecretary', 'isLeader'])->group(function () {
        Route::get('/meet/add', [MeetAbsenceController::class, 'create'])->name('meet.create');
    });
    // Mengaplikasikan middleware untuk peran `isMember`
    Route::middleware(array("isMember"))->group(function () {
        ...
        Route::prefix("/dashboard")->group(function () {
            ...
            Route::prefix("/admin")->group(function () {
                ...
                // Mengaplikasikan middleware untuk peran `isLeader`
                Route::middleware(array("isLeader"))->group(function () {
                    // Rute resource untuk mengelola pengguna dan anggota
                ...
                // Mengaplikasikan middleware untuk peran `isChamberlain`
                Route::middleware(array("isChamberlain"))->group(function () {
                    // Rute untuk manajemen keuangan
                ...
                // Mengaplikasikan middleware untuk peran `isSecretary`
                Route::middleware(array("isSecretary"))->group(function () {
                    // Rute resource untuk mengelola catatan acara dan dokumen
                ...
                // Mengaplikasikan middleware untuk peran `isRsdm`
                Route::middleware(array("isRsdm"))->group(function () {
                    // Rute resource untuk pertemuan dan absensi
                ...
                // Mengaplikasikan middleware untuk peran `isKominfo`
                Route::middleware(array("isKominfo"))->group(function () {
                    // Rute untuk sertifikat acara dan manajemen galeri
            ...
            // Rute untuk profil dan aktivitas pengguna
...
// Mengaplikasikan middleware untuk memastikan pengguna belum login
